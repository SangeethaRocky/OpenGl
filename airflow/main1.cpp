...
void front()
{
	...
	output(400,130,"THE OXFORD COLLEGE OF ENGINEERING",fonts[3]);
	...
	glColor3f(0.3,0.5,0.8);
	output(180,450,"SANGEETHA P",fonts[3]);
	output(380,450,"TRISHA R",fonts[3]);
	output(580,450,"VARSHA N",fonts[3]);
	output(770,450,"POOJA H S",fonts[3]);
	glColor3f(0.0,0.6,0.3);
	output(180,400,"(1OX19CS089)",fonts[0]);
	output(380,400,"(1OX19CS110)",fonts[0]);
    output(580,400,"(1OX19CS115)",fonts[0]);
    output(770,400,"(1OX20CS404)",fonts[0]);
...
void menu()
{
	...
	glColor3f(0.5,0.2,0.6);
	output(500,60,"[ Dept. of CS&E, TOCE ]",fonts[0]);
}
void help()
{
	glColor3f(0.8,0.1,0.2);
